...
export const HeroHighlight = ({
  ...
  return (
    ...
    >
      ...
      />
      <motion.div
        className="dark:hidden absolute inset-0 opacity-0 group-hover:opacity-100 transition duration-300 pointer-events-none"
        style={{
      ...
      />
      <motion.div
        className="hidden dark:block absolute inset-0 opacity-0 group-hover:opacity-100 transition duration-300 pointer-events-none"
        style={{
